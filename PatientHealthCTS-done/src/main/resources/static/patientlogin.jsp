    ...
    <div class="container col-xl-10 col-xxl-8 px-4 py-5">
        <div class="row align-items-center g-lg-5 py-5">
          <div class="col-lg-7 text-center text-lg-start">
            ...
            <p style="color:#03045E"class="col-lg-10 fs-4">Provide information correctly. Follow the instruction properly given by the physician. Sign in track your health conditions regularly.</p>
          </div>
          ...
          <h4>${errmsg }</h4> 
            <form class="p-4 p-md-5 border rounded-3 bg-light" action="checkp" method="post">
              <div class="form-floating mb-3">
                ...
                <input type="text" class="form-control" id="floatingInput" placeholder="Patient Id" name="userId">
