    ...
    <div class="container col-xl-10 col-xxl-8 px-4 py-5">
        <div class="row align-items-center g-lg-5 py-5">
          <div class="col-lg-7 text-center text-lg-start">
            <h1 style="color:#000000" class="display-4 fw-bold lh-1 mb-3">Patient Health Monitoring Portal</h1>
            <p style="color:#03045E" class="col-lg-10 fs-4">A physician should endeavour to add to the comfort of the sick by making his visits at the hour indicated to the patients. A physician advising a patient to seek service of another physician is acceptable, however, in case of emergency a physician must treat the patient.</p>
          </div>

          <div class="col-md-10 mx-auto col-lg-5">
          <h4 style="color: red">${errmsg }</h4><h4>${errormsg}</h4>
