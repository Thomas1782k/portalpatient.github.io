    ...
    <div class="container col-xl-10 col-xxl-12 px-4 py-5">
        ...
        <div class="row align-items-center g-lg-5 py-5">
          ...
          <div class="col-md-10 mx-auto col-lg-5">
            ...
            <form class="p-2 p-md-1 row g-3 border rounded-3 bg-light" action="active" method="post">
              ...
              <div class="form-floating mb-3">
                <input type="datetime-local" class="form-control" id="floatingInput3" placeholder="Date" name="dateOfActivity">
                <label for="floatingInput3">Date</label>
              </div>
              <div class="form-floating mb-3">
                <input type="text" class="form-control" id="floatingInput4" placeholder="Activity" name="activity">
                <label for="floatingInput4">Activity</label>
              </div>
<div class="form-floating mb-3">
                <input type="datetime-local" class="form-control" id="floatingInput3" placeholder="Workout" name="timeOfWorkOut">
                <label for="floatingInput3">Time of workout</label>
              </div>
