        ...
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
          ...
          <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
           <!--  <li>
            ...
            <li>
              <a href="/appointment?dname=${dname }" class="nav-link text-white">
                <svg class="bi d-block mx-auto mb-1" width="24" height="24"><use xlink:href="#table"/></svg>
                Appointment
              </a>
            </li>
            <li>
              <a href="/updaterec?${dname }" class="nav-link text-white">
...
<main>
    ...
    <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
        <h1 class="display-4 fw-normal">Welcome ${dname}</h1>
        <p class="fs-5 text-muted">Hello. Wishing you the best day. Kindly check your appointment list to cure more and more patients. </p>
      </div>
      ...
      <div class="row row-cols-1 row-cols-md-3 mb-3 text-center justify-content-center">
        <div class="col">
          <div class="card mb-4 rounded-3 shadow-sm">
            <div class="card-header py-3">
              <h4 class="my-0 fw-normal">Appointment</h4>
            </div>
            <div class="card-body">
              <h1 class="card-title pricing-card-title">List all the active appointments</h1>
              <form action="appointment" >
               <% session.setAttribute("did",session.getAttribute("did").toString()); %>
               <input type="hidden" name="dname" value="${dname }">
               <button type="submit" class="w-100 btn btn-lg btn-outline-primary">View Appointment</button>
              </form>
            </div>
          </div>
        </div>
        <div class="col">
            <div class="card mb-4 rounded-3 shadow-sm">
              <div class="card-header py-3">
                <h4 class="my-0 fw-normal">Records</h4>
              </div>
              <div class="card-body">
                <h1 class="card-title pricing-card-title">List all the active  patient records</h1>
                
                <form action="updaterec">
                <input type="hidden" name="dname" value="${dname }">
                <% session.setAttribute("did",session.getAttribute("did").toString()); %>
              <button type="submit" class="w-100 btn btn-lg btn-outline-primary">Update Records</button>
              </form>
              </div>
            </div>
          </div>
