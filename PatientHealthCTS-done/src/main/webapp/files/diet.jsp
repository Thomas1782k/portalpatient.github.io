    ...
    <div class="container col-xl-10 col-xxl-12 px-4 py-5">
        ...
        <div class="row align-items-center g-lg-5 py-5">
          ...
          <div class="col-md-10 mx-auto col-lg-5">
            ...
            <form class="p-2 p-md-1 row g-3 border rounded-3 bg-light" action="dietMonitor" method="post">
             ...
             <input type="hidden" name="pid" value=" ${pid}">
              ...
              <div class="form-floating mb-3">
                <input type="datetime-local" class="form-control" id="floatingInput3" placeholder="Date" name="dateOfDiet">
                <label for="floatingInput3">Date</label>
              </div>
               <div class="form-floating mb-3">
                <input type="number" class="form-control" id="floatingInput4" placeholder="Diet" name="diet">
                <label for="floatingInput4">Diet</label>
              </div>
<div class="form-floating mb-3">
                <input type="datetime-local" class="form-control" id="floatingInput3" placeholder="Time of Intake" name="timeOfDietIntake">
