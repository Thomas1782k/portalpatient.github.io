    ...
    <div class="container col-xl-10 col-xxl-8 px-4 py-5">
        <div class="row align-items-center g-lg-5 py-5">
          <div class="col-lg-7 text-center text-lg-start">
            ...
            <p style="color:#03045E" class="col-lg-10 fs-4">Sign in to fix the appointment for patients. Check the date and time carefully while appointing patient to doctor. </p>
          </div>
          ...
          <h4>${errmsg }</h4>
            ...
            <div class="png-adm">
             <img alt="Admin" width="300px" height="500px" src="/files/png-adm.png">
             </div>
          </div>
